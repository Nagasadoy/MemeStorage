 ...
 */
final class Version20221215150840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE combination (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, memes_id INT DEFAULT NULL, tags_id INT DEFAULT NULL, INDEX IDX_DE091AAFA76ED395 (user_id), INDEX IDX_DE091AAFF270FEA8 (memes_id), INDEX IDX_DE091AAF8D7B4FB4 (tags_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meme (id INT AUTO_INCREMENT NOT NULL, file_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE combination ADD CONSTRAINT FK_DE091AAFA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE combination DROP FOREIGN KEY FK_DE091AAFA76ED395');
